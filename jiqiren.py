...
async def autobeg(ctx):
    ...
    print(f"{Fore.LIGHTMAGENTA_EX}dank autobeg is set to {Fore.LIGHTGREEN_EX}{vautobeg}{Fore.RESET}")
    try:
        await ctx.message.delete()
    except:
        pass
...
async def autohunt(ctx):
    ...
    print(f"{Fore.LIGHTMAGENTA_EX}dank autohunt is set to {Fore.LIGHTGREEN_EX}{vautohunt}{Fore.RESET}")
    try:
        await ctx.message.delete()
    except:
        pass
...
async def autofish(ctx):
    ...
    print(f"{Fore.LIGHTMAGENTA_EX}dank autofish is set to {Fore.LIGHTGREEN_EX}{vautofish}{Fore.RESET}")
    try:
        await ctx.message.delete()
    except:
        pass
...
async def automeme(ctx):
    ...
    print(f"{Fore.LIGHTMAGENTA_EX}dank automeme is set to {Fore.LIGHTGREEN_EX}{vautomeme}{Fore.RESET}")
    try:
        await ctx.message.delete()
    except:
        pass
...
async def autodaily(ctx):
    ...
    print(f"{Fore.LIGHTMAGENTA_EX}dank autodaily is set to {Fore.LIGHTGREEN_EX}{vautodaily}{Fore.RESET}")
    try:
        await ctx.message.delete()
    except:
        pass
...
async def owoautohunt(ctx):
    ...
    print(f"{Fore.LIGHTMAGENTA_EX}owoautohunt is set to {Fore.LIGHTGREEN_EX}{vowoautohunt}{Fore.RESET}")
    try:
        await ctx.message.delete()
    except:
        pass
...
async def owoautosacrifice(ctx):
    ...
    print(f"{Fore.LIGHTMAGENTA_EX}owoautosacrifice is set to {Fore.LIGHTGREEN_EX}{vowoautosacrifice}{Fore.RESET}")
    try:
        await ctx.message.delete()
    except:
        pass
...
async def owoautosell(ctx):
    ...
    print(f"{Fore.LIGHTMAGENTA_EX}owoautosell is set to {Fore.LIGHTGREEN_EX}{vowoautosell}{Fore.RESET}")
    try:
        await ctx.message.delete()
    except:
        pass
...
async def owoautodaily(ctx):
    ...
    print(f"{Fore.LIGHTMAGENTA_EX}owoautodaily is set to {Fore.LIGHTGREEN_EX}{vowoautodaily}{Fore.RESET}")
    try:
        await ctx.message.delete()
    except:
        pass
